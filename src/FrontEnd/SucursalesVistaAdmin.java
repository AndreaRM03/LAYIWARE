 ...
 * @author red-p
 */
public class SucursalesVistaAdmin extends javax.swing.JFrame {

    /**
     * Creates new form SucursalesVistaAdmin
     */
    public SucursalesVistaAdmin() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SucursalesVistaAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SucursalesVistaAdmin().setVisible(true);
            }
        });
    }
