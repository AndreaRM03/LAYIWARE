 ...
 * @author red-p
 */
public class VistaEmpleadosActualizar2 extends javax.swing.JFrame {

    /**
     * Creates new form SucursalesVistaAdmin
     */
    public VistaEmpleadosActualizar2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnActualizarSucursal.setText("Actualizar Empleado");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaEmpleadosActualizar2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaEmpleadosActualizar2().setVisible(true);
            }
        });
    }
